...
for i in range(100):
    submit.loc[len(submit.index)]=[2019,"SCS","","",SCS_2019[i]]
for i in range(100):
    submit.loc[len(submit.index)]=[2019,"FCS","","",FCS_2019[i]]  
for i in range(100):
    submit.loc[len(submit.index)]=[2020,"SCS","","",SCS_2020[i]]
for i in range(100):
    submit.loc[len(submit.index)]=[2020,"FCS","","",FCS_2020[i]]  
for i in range(4096):
    for j in range(100):
